...
def process_file(file_path, output_dir, text_col, label_col, chunk_rows):
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=args.workers) as ex:
        for file_path in input_dir.glob("*.parquet"):
            futures.append(ex.submit(process_file, file_path, output_dir, args.text_col, args.label_col, args.chunk_rows))
